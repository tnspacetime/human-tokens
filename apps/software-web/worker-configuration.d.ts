/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a583e08377193e49f1dcb6a71cac28a9)
// Runtime types generated with workerd@1.20260811.1 2026-08-14 nodejs_compat
interface __BaseEnv_Env {
	HUMAN_TOKENS_SOFTWARE_LATEST: KVNamespace;
	HUMAN_TOKENS_SOFTWARE_EXTRAS: KVNamespace;
	HUMAN_TOKENS_SOFTWARE_MEDIA: R2Bucket;
	AI: Ai;
	CURATION_API_TOKEN: string;
	DATABASE_URL: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CURATION_API_TOKEN" | "DATABASE_URL">> {}
}
